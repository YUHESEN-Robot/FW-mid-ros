...
namespace yhs_tool
{
  ...
  void CanControl::front_velocity_free_ctrl_cmdCallBack(const yhs_can_msgs::front_velocity_free_ctrl_cmd msg)
  {
    ...
    sendData_u_tem[0] = sendData_u_tem[0] | (0xf0 & ((velocity_lf & 0x0f) << 4));

    sendData_u_tem[1] = (velocity_lf >> 4) & 0xff;

    sendData_u_tem[2] = sendData_u_tem[2] | (0x0f & (velocity_lf >> 12));

    sendData_u_tem[2] = sendData_u_tem[2] | (0xf0 & ((velocity_rf & 0x0f) << 4));

    sendData_u_tem[3] = (velocity_rf >> 4) & 0xff;

    sendData_u_tem[4] = sendData_u_tem[4] | (0x0f & (velocity_rf >> 12));
    ...
    send_frames_.can_id = 0x98C4D3D0;
    send_frames_.can_dlc = 8;
  ...
  void CanControl::rear_velocity_free_ctrl_cmdCallBack(const yhs_can_msgs::rear_velocity_free_ctrl_cmd msg)
  {
    ...
    sendData_u_tem[0] = sendData_u_tem[0] | (0xf0 & ((velocity_lr & 0x0f) << 4));

    sendData_u_tem[1] = (velocity_lr >> 4) & 0xff;

    sendData_u_tem[2] = sendData_u_tem[2] | (0x0f & (velocity_lr >> 12));

    sendData_u_tem[2] = sendData_u_tem[2] | (0xf0 & ((velocity_rr & 0x0f) << 4));

    sendData_u_tem[3] = (velocity_rr >> 4) & 0xff;

    sendData_u_tem[4] = sendData_u_tem[4] | (0x0f & (velocity_rr >> 12));
    ...
    send_frames_.can_id = 0x98C4D4D0;
    send_frames_.can_dlc = 8;
  ...
  void CanControl::front_angle_free_ctrl_cmdCallBack(const yhs_can_msgs::front_angle_free_ctrl_cmd msg)
  {
    ...
    sendData_u_tem[0] = sendData_u_tem[0] | (0xf0 & ((angle_lf & 0x0f) << 4));

    sendData_u_tem[1] = (angle_lf >> 4) & 0xff;

    sendData_u_tem[2] = sendData_u_tem[2] | (0x0f & (angle_lf >> 12));

    sendData_u_tem[2] = sendData_u_tem[2] | (0xf0 & ((angle_rf & 0x0f) << 4));

    sendData_u_tem[3] = (angle_rf >> 4) & 0xff;

    sendData_u_tem[4] = sendData_u_tem[4] | (0x0f & (angle_rf >> 12));
    ...
    send_frames_.can_id = 0x98C4D5D0;
    send_frames_.can_dlc = 8;
  ...
  void CanControl::rear_angle_free_ctrl_cmdCallBack(const yhs_can_msgs::rear_angle_free_ctrl_cmd msg)
  {
    ...
    sendData_u_tem[0] = sendData_u_tem[0] | (0xf0 & ((angle_lr & 0x0f) << 4));

    sendData_u_tem[1] = (angle_lr >> 4) & 0xff;

    sendData_u_tem[2] = sendData_u_tem[2] | (0x0f & (angle_lr >> 12));

    sendData_u_tem[2] = sendData_u_tem[2] | (0xf0 & ((angle_rr & 0x0f) << 4));

    sendData_u_tem[3] = (angle_rr >> 4) & 0xff;

    sendData_u_tem[4] = sendData_u_tem[4] | (0x0f & (angle_rr >> 12));
    ...
    send_frames_.can_id = 0x98C4D6D0;
    send_frames_.can_dlc = 8;
